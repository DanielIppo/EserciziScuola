...
class Conto{
    ...
    void Versamento(){
        ...
        if (quantita <= 2000){
            saldo = saldo - quantita;
            cout << "\n\nPrelevato correttamente, ritorno alla Home..."<<endl;
            sleep(5);
            Clear();
            Home(); 
        } else {
            cout << "\n\nHai digitato un numero troppogrande o hai sbagliato a digitare, riprova.."<<endl;
            sleep(5);
            Clear();
            Versamento(); 
        }
    ...
    void Home(){
        ...
        switch (scelta){
            ...
            case 3:Clear();Info();
            default:cout << "Hai sbagliato a digitare, riprova..."<<endl; 
            sleep(4);
            Clear();
            Home();
        }
